...
public class ProjectController {
    ...
    @GetMapping("/{code}")
    @RolesAllowed("Manager")//let's do this only manager only
    ...
    @RolesAllowed("Manager")// KIND OF UPDATING; MANAGER GOES TO PROJEXT AND CLICK THE COMPLETE IT, WE ARE UPDATING ONE EXISTING PROJECT
